...
- **La serie 5000 non si rigenera da prompt, e il motivo vale per tutte.** Il 2026-08-10 il render in produzione è stato riconosciuto come inventato da chi vede quelle vetture ogni giorno. Ritirandolo è venuto fuori che l'immagine giusta era già stata nel repository: una vettura 5014 con la matricola, la linea 15 sul rullo, i marchi TORINO 2006 e STT, gli interni della cabina. È stata sostituita da una **rigenerazione da prompt**, pulita e priva di tutti quei dettagli, per rimettere il fondo studio scuro. Da qui la regola: quando un render viene da un'immagine di riferimento, **rilavorarlo significa partire da quell'immagine**, non ridescriverla a parole a un generatore. `renderPrompt` della serie 5000 è vuoto apposta. La differenza fra le due versioni si vede a colpo d'occhio ed è sempre la stessa: i dettagli che solo un mezzo vero ha.
